...
import { CachingV3PoolProvider, MetricLoggerUnit, NodeJSCache } from '@offsetcarbon/smart-order-router'
...
import { ProviderConfig } from '@offsetcarbon/smart-order-router/build/main/providers/provider'
import { metric } from '@offsetcarbon/smart-order-router/build/main/util/metric'
import { setupTables } from '../../../../dbSetup'
import {
  DAI_MAINNET as DAI,
  USDC_MAINNET as USDC,
} from '@offsetcarbon/smart-order-router/build/main/providers/token-provider'
